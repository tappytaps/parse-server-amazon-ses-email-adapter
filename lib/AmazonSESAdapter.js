...
class AmazonSESAdapter extends _MailAdapter.MailAdapter {
  constructor(options = {}) {
    ...
    this.ses = new _amazonSesMailer.default(accessKeyId, secretAccessKey, region);
  ...
  _sendMail(options) {
    ...
    return (0, _co.default)(function* () {
      let plainTextEmail, htmlEmail, compiled; // Load plain-text version
      ...
      if (pathHtml) {
        htmlEmail = yield loadEmailTemplate(pathHtml); // Compile html template
